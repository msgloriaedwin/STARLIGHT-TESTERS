...
import welcomeImage from "../../../../public/assets/email-assets/welcome.svg";
        ...
        <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
          <div className="bg-white">
            ...
            <ul className="list-disc list-inside mb-4 space-y-2">
              <li>
                Interactive Learning: Engage with AI-powered bingo games that
