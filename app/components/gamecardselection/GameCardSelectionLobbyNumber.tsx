...
const GameCardSelectionLobby = () => {
	...
	useEffect(() => {
		if (revealedIndices.length === 5) {
			sessionStorage.setItem("userSelected", JSON.stringify(hiddenNumbersArray))
	...
	return (
		<div className="w-full h-full flex justify-center">
			<div
				className={`flex flex-col w-full max-w-sm md:max-w-[600px] h-fit`}>
