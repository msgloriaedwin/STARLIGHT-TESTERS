  ...
  return (
    <section className="pt-36 md:pt-[11.5rem] flex items-center flex-col gap-x-6 justify-between max-w-[1200px] mx-auto lg:flex-row pb-20">
      <div className=" mx-auto px-2 sm:px-4 text-center lg:text-start">
        <h1 className="text-[2.25rem] sm:text-[2.5rem] lg:text-[4rem] leading-[1.2] font-bold text-primary-700 mb-4">
          {t("title")}
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-8 w-full px-3 md:px-0">
          ...
          <form
            ...
            className="flex  items-center pl-2 pr-2.5 justify-between border border-primary-700 h-12 bg-white rounded-lg w-full sm:max-w-[50%] "
          >
            <input
              type="text"
            ...
            <Link href="/join-game">
              <button
                type="submit"
                className=" text-primary-700 whitespace-nowrap text-sm"
              >
                {t("joinGameButton")}
              </button>
            </Link>
