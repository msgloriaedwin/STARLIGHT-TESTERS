...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-8 w-8 rounded-full shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-10 data-[state=unchecked]:translate-x-0 data-[state=unchecked]:bg-white  data-[state=checked]:bg-[#4CAF50]  "
      )}
    />
  </SwitchPrimitives.Root>
));
