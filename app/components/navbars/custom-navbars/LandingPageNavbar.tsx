        ...
        <div className='w-full'>
            ...
            {menuIsOpen === true ? <ul className='w-[100%] z-[995] md:hidden fixed top-[85px] flex gap-4 pt-[50px] flex-col min-h-[90vh] bg-white p-4 rounded-lg'>
                ...
                <div className='flex flex-col gap-4'>
                    <button onClick={() => onLogin()} className='bg-[#FAD02C] w-[100%] shadow-custom-inset text-white py-2 px-4 rounded-[8px]'>Login</button>
                    <button onClick={() => onSignup()} className='bg-[#00658B] w-[100%] shadow-custom-inset text-white py-2 px-4 rounded-[8px]'>Signup</button>
                </div>
            </ul> : ''}
        </div>
    )
