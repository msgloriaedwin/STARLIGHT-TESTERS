...
const GameStartNavbar = () => {
    return (
        <Navbar className='flex items-center justify-between w-full bg-[#fffdfd] px-6 md:px-20 py-6'>
            ...
            <button className='flex md:hidden shadow-custom-inset items-center bg-[#00658B] border rounded-[8px] gap-[.5em] border-[#00658B] text-white justify-center p-2 outline-1'>
                <Menu />
            </button>
        </Navbar>
    )
