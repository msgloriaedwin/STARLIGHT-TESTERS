        ...
        <div className={`font-["dm_sans"] flex`}>
          <div className="relative">
            <div
              ...
              className={`z-1 relative cursor-pointer md:min-w-16 max-w-10 w-full max-h-14 md:max-h-20 rounded-tl rounded-tr-none rounded-br rounded-bl-none  bg-[#AEDCB0] box-border overflow-hidden shrink-0 flex flex-col items-center justify-center py-4 md:py-[1.5rem] px-[1rem] text-center text-[1.8rem] md:text-[2.7rem] border-b-[3px] border-solid border-primaryBlue border-l-[3px] text-primary-900 ${
